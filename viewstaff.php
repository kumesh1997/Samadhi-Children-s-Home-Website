...
">
                <header>
                    <h1 style=" padding-left: 50px;">View Staff</h1>
                </header>
            </div>
...
<div class="container" style="float:right;">
        ...
        <a style="float:right; "class="btn btn-primary" href="addstaff.php">ADD New Staff</a>
        <table class="table">
       <thead>
        <tr>
            <th>NIC</th>
        ...
        <tbody>
            ...
            while($row=$result->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td><a class="btn btn-info" href="updatestaff.php?id=<?php echo $row['nic'] ?>" >Edit</a>&nbsp;&nbsp;
                    <a class="btn btn-danger" href="deletestaff.php?id=<?php echo $row['nic'] ?>">Delete</a>
